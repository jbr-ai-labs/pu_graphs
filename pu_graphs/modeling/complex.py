...
class ComplEx(nn.Module):
    ...
    def __init__(self, n_nodes: int, n_relations: int, embedding_dim: int):
        ...
        self.node_embedding_real = nn.Embedding(num_embeddings=n_nodes, embedding_dim=embedding_dim)
        self.node_embedding_img = nn.Embedding(num_embeddings=n_nodes, embedding_dim=embedding_dim)
        ...
        self.relation_embedding_real = nn.Embedding(num_embeddings=n_relations, embedding_dim=embedding_dim)
        self.relation_embedding_img = nn.Embedding(num_embeddings=n_relations, embedding_dim=embedding_dim)
